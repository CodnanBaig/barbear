...
export default function WomenPage() {
  ...
  return <main>
    <CollectionHero eyebrow="WOMEN / DROP 01" title="FORM IN" outline="MOTION." image="/editorial/women-training.jpg" position="52% 42%" stat="TRAIN / STUDIO / EVERYDAY" />
    ...
    <section className="women-editorial">
      ...
      <div className="women-editorial-image" data-parallax="0.08" />
    </section>
    <Footer />
  </main>
}
